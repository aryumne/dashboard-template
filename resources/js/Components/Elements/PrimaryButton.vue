...
<template>
    <button
        :type="buttonType"
        class="inline-flex h-full px-3 py-2 items-center border-2 rounded-md font-semibold text-xs capitalize tracking-wide focus:bg-accent active:bg-accent active:text-primary focus:text-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-0 transition ease-in-out duration-150"
        :disabled="disabled"
        :class="[
            !isOutline
